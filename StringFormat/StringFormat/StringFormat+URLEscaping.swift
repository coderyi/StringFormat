//
//  StringFormat+URLEscaping.swift
//  StringFormat
//
...
extension StringFormat {
    ...
    public class func doesUrlMatchText(url: String, text: String, fullText: String) -> Bool {
    ...
    public class func isValidUrl(_ url: String, validSchemes: [String: Bool] = ["http": true, "https": true]) -> Bool {
    ...
    public class func explicitUrl(_ url: String) -> String {
        var url = url
    ...
    public class func urlEncodedStringFromString(_ string: String) -> String {
        ...
        if let result = CFURLCreateStringByAddingPercentEscapes(nil, nsString as CFString, nil, "?!@#$^&%*+=,:;'\"`<>()[]{}/\\|~ " as CFString, CFStringConvertNSStringEncodingToEncoding(String.Encoding.utf8.rawValue)) {
